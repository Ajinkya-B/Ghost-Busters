...
const UploadTranscriptsFromVoiceflow = () => {
    ...
    const retrieveTranscripts = async () => {
        const response = await axios.get("https://ghost-busters-f6c6b7uoga-uc.a.run.app/api/v1/transcripts/getCredentials")
        axios.post('https://ghost-busters-f6c6b7uoga-uc.a.run.app/api/v1/transcripts/trimmed', response.data)
            .then(response => {
